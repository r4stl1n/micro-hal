...
func (cmd *Calibrate) Run(_ *cobra.Command, args []string) {
	...
	newMinImpulse := cmd.minImpulseCalibrate(pca0, servoId, actuationRange, minImpulse, maxImpulse, step)

	newMaxImpulse := cmd.maxImpulseCalibrate(pca0, servoId, actuationRange, newMinImpulse, maxImpulse, step)
